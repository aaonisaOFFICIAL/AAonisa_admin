...
//     try {
//       const offer = collection(JSdb, "buissness-listing");
//       const q = query(offer);
//       const querySnapshot = await getDocs(q);

//       const OfferInRange = querySnapshot.docs.map((doc) => {
//         const data = doc.data();
//         return { id: doc.id, ...data };
//       });

//       OfferInRange.forEach(async (data) => {
//         if (data.latitude == null) {
//         //   const docRef = doc(JSdb, "buissness-listing", data.id);
