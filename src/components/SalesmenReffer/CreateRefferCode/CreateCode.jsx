...
const CreateCode = () => {
  ...
  const createData = async () => {
    if (!location || !franchise || !code || !name || !number || !address || !adhaar || !bankName || !accName || !accNumber || !ifsc) {
  ...
  return (
    <div className="create-code">
      <div className="create-input">
        <p>ANS</p>
        <Input
          style={{ border: '1px solid #000', width: '28%' }}
          placeholder="Location"
          onChange={(e) => setLocation(e.target.value)}
        />
        <Input
          style={{ border: '1px solid #000', width: '28%' }}
          placeholder="Franchise/Salespartner"
