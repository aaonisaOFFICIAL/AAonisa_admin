...
const EditJSCategory = () => {
  ...
  const getData = async () => {
    try {
        const docRef = doc(JSdb, "categories", id); // Reference to the document by ID
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
          const docRef = doc(JSdb, "categories", id);
